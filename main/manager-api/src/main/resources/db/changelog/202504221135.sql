...
('SYSTEM_ASR_TencentASR', 'ASR', 'tencent', 'Tencent Voice Recognition', '[{"key":"appid","label":"APP ID","type":"string"},{"key":"secret_id","label":"Secret ID","type":"string"},{"key":"secret_key","label":"Secret Key","type":"string"},{"key":"output_dir","label":"output directory","type":"string"}]', 4, 1, NOW(), 1, NOW());
