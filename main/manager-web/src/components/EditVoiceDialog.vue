  ...
  <el-dialog :visible.sync="dialogVisible" width="900px" @close="handleClose" class="compact-dialog" :append-to-body="true">
    <el-form :model="voiceForm" :rules="rules" ref="voiceForm" label-width="80px">
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="Voice Code" prop="voiceCode">
            <el-input v-model="voiceForm.voiceCode" placeholder="Please enter the content" class="compact-input"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="Voice Name" prop="voiceName">
            <el-input v-model="voiceForm.voiceName" placeholder="Please enter the content" class="compact-input"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="Language Type" prop="languageType">
            <el-input v-model="voiceForm.languageType" placeholder="Please enter the content" class="compact-input"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-form-item label="Remark" prop="remark">
        <el-input v-model="voiceForm.remark" type="textarea" :rows="2" placeholder="Please enter the content" class="compact-textarea"
        ></el-input>
...
export default {
  ...
  data() {
    return {
      ...
      generatedAudio: null,
      rules: {
        voiceCode: [{ required: true, message: 'Please enter the voice code', trigger: 'blur' }],
        voiceName: [{ required: true, message: 'Please enter the voice name', trigger: 'blur' }]
      }
    }
  },
  watch: {
