      ...
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
        ...
        <div style="display: flex; align-items: center; gap: 20px;">
          <div style="display: flex; align-items: center;">
            <span style="margin-right: 8px;">Is Enabled</span>
      ...
      <el-form :model="formData" label-width="100px" label-position="left" class="custom-form">
        <div style="display: flex; gap: 20px; margin-bottom: 0;">
          <el-form-item label="Model Name" prop="modelName" style="flex: 1;">
            <el-input v-model="formData.modelName" placeholder="Please enter the model name" class="custom-input-bg"></el-input>
          </el-form-item>
          <el-form-item label="Model Code" prop="modelCode" style="flex: 1;">
            <el-input v-model="formData.modelCode" placeholder="Please enter the model code" class="custom-input-bg"></el-input>
          </el-form-item>
        </div>
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 0;">
          ...
          <el-form-item label="Sort" prop="sortOrder" style="flex: 1;">
            <el-input v-model="formData.sort" type="number" placeholder="Please enter the sort" class="custom-input-bg"></el-input>
          </el-form-item>
        </div>


        <el-form-item label="Doc Link" prop="docLink" style="margin-bottom: 27px;">
          <el-input v-model="formData.docLink" placeholder="Please enter the doc link" class="custom-input-bg"></el-input>
        </el-form-item>

        <el-form-item label="Remark" prop="remark" class="prop-remark">
          <el-input v-model="formData.remark" type="textarea" :rows="3" placeholder="Please enter the model remark" :autosize="{ minRows: 3, maxRows: 5 }"
            class="custom-input-bg"></el-input>
        </el-form-item>
      </el-form>

      <div style="font-size: 20px; font-weight: bold; color: #3d4566; margin-bottom: 15px;">Call Info</div>
      <div style="height: 2px; background: #e9e9e9; margin-bottom: 22px;"></div>
      ...
      Api.model.getModelProviders(this.modelType, (data) => {
        this.providers = data.map(item => ({
          ...
          fields: JSON.parse(item.fields || '[]').map(f => ({
            ...
            placeholder: `Please enter the ${f.label}`
          }))
        }))
