    ...
    <el-dialog :visible.sync="dialogVisible"  width="24%" center>
      ...
      <div style="margin: 22px 15px;">
        ...
        <div class="input-46" style="margin-top: 12px;">
          <el-input placeholder="Please enter the old password" v-model="oldPassword" type="password" show-password />
        </div>
        ...
        <div class="input-46" style="margin-top: 12px;">
          <el-input placeholder="Please enter the new password" v-model="newPassword" type="password" show-password />
        </div>
        <div style="font-weight: 400;font-size: 14px;text-align: left;color: #3d4566;margin-top: 12px;">
          <div style="color: red;display: inline-block;">*</div>
        ...
        <div class="input-46" style="margin-top: 12px;">
          <el-input placeholder="Please enter the new password again" v-model="confirmNewPassword" type="password" show-password />
        </div>
      </div>
  ...
  methods: {
    ...
    confirm() {
      ...
      if (this.newPassword === this.oldPassword) {
        this.$message.error('new password cannot be the same as the current password');
        return;
      }
