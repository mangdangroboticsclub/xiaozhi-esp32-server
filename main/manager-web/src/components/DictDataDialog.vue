    ...
    <el-dialog :title="title" :visible.sync="dialogVisible" width="30%" @close="handleClose">
        <el-form :model="form" :rules="rules" ref="form" label-width="100px">
            <el-form-item label="dictionary label" prop="dictLabel">
                <el-input v-model="form.dictLabel" placeholder="Please enter the dictionary label"></el-input>
            </el-form-item>
            <el-form-item label="dictionary value" prop="dictValue">
                <el-input v-model="form.dictValue" placeholder="Please enter the dictionary value"></el-input>
            </el-form-item>
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                dictLabel: [{ required: true, message: 'Please enter the dictionary label', trigger: 'blur' }],
                dictValue: [{ required: true, message: 'Please enter the dictionary value', trigger: 'blur' }]
            }
        }
    },
    watch: {
