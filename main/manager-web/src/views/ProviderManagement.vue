      ...
      <div class="right-operations">
        <el-dropdown trigger="click" @command="handleSelectModelType" @visible-change="handleDropdownVisibleChange">
          <el-button class="category-btn">
            Type Selection {{ selectedModelTypeLabel }}<i class="el-icon-arrow-down el-icon--right"
        ...
        <el-input placeholder="please enter provider name to search" v-model="searchName" class="search-input" @keyup.enter.native="handleSearch"
          clearable />
        ...
        <div class="content-area">
          <el-card class="provider-card" shadow="never">
            <el-table ref="providersTable" :data="filteredProvidersList" class="transparent-table" v-loading="loading"
              ...
              <el-table-column label="Type" prop="modelType" align="center" width="200">
                <template slot="header" slot-scope="scope">
                  <el-dropdown trigger="click" @command="handleSelectModelType"
                    ...
                    <span class="dropdown-trigger" :class="{ 'active': isDropdownOpen }">
                      Type{{ selectedModelTypeLabel }} <i class="dropdown-arrow"
              ...
              <el-table-column label="Supplier Code" prop="providerCode" align="center" width="150"></el-table-column>
              ...
              <el-table-column label="Field Configuration" align="center">
                <template slot-scope="scope">
                  <el-popover placement="top-start" width="400" trigger="hover">
                    ...
                    <el-button slot="reference" size="mini" type="text">View Field</el-button>
                  </el-popover>
                </template>
              </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      providersList: [],
      modelTypes: [
        { value: "ASR", label: "Voice Detection" },
        { value: "TTS", label: "TTS" },
        { value: "LLM", label: "LLM" },
  ...
  methods: {
    ...
    deleteSelectedProviders() {
      ...
      if (selectedRows.length === 0) {
        this.$message.warning({
          message: "please select the provier to be deleted",
          showClose: true
        });
        return;
      }
    ...
    deleteProvider(row) {
      ...
      this.$confirm(`confirm to delete ${providerCount} selected providers?`, 'Warning', {
        ...
        Api.model.deleteModelProviderByIds(ids, ({ data }) => {
          if (data.code === 0) {
            ...
            this.$message.success({
              message: `Delete ${providerCount} parameters successfully`,
              showClose: true
            });
          } else {
            this.$message.error({
