<template>
  <div class="welcome">
    ...
    <div class="operation-bar">
      <h2 class="page-title">Server Side Management</h2>
    </div>
        ...
        <div class="content-area">
          <el-card class="params-card" shadow="never">
            <el-table ref="paramsTable" :data="paramsList" class="transparent-table" v-loading="loading"
              ...
              <el-table-column label="Operation" prop="operator" align="center" show-overflow-tooltip>
                <template slot-scope="scope">
    ...
    return {
      ...
      actionMap: {
        restart: {
          ...
          message: "Confirm to restart server?",
          confirmText: "Restart",
        },
        update_config: {
          value: 'update_config',
          title: "Update Config",
          message: "confirm to update config？",
          confirmText: "update",
        }
      },
      currentPage: 1,
      ...
      this.$confirm(actionItem.message, actionItem.title, {
        ...
        Api.admin.sendWsServerAction({
          ...
          this.$message.success({
            message: `${actionItem.title} Success`,
            showClose: true
          })
        })
      })
