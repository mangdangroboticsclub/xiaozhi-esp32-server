        ...
        <div class="operation-bar">
            ...
            <div class="action-group">
                <div class="search-group">
                    <el-input placeholder=" Please enter the dictionary value label for query" v-model="search" class="search-input" clearable
                ...
                <div class="dict-type-panel">
                    <div class="dict-type-header">
                        ...
                        <el-button type="danger" size="mini" @click="batchDeleteDictType"
                            ...
                            Batch deletion of dictionary types
                        </el-button>
                    </div>
                        ...
                        <div class="table-footer">
                            <div class="batch-actions">
                                <el-button size="mini" type="primary" @click="selectAllDictData">
                                    {{ isAllDictDataSelected ? 'Unselect All' : 'Select All' }}
                                </el-button>
                                ...
                                <el-button size="mini" type="danger" icon="el-icon-delete" @click="batchDeleteDictData">
                                    Batch deletion of dictionary data
                                </el-button>
                            </div>
    ...
    methods: {
        ...
        batchDeleteDictType() {
            if (this.selectedDictTypes.length === 0) {
                this.$message.warning('please select dictionary type to be deleted')
                return
            }

            this.$confirm('confirm to delete selected dictionary type?', 'NOTE', {
        ...
        deleteDictData(row) {
            this.$confirm('confirm to delete selected dictionary data?', 'NOTE', {
                confirmButtonText: 'Confirm',
                cancelButtonText: 'Cancel',
                type: 'warning'
            }).then(() => {
        ...
        batchDeleteDictData() {
            ...
            if (selectedRows.length === 0) {
                this.$message.warning('please select dictionary data to be deleted')
                return
            }

            this.$confirm(`confirm to delete selected ${selectedRows.length} dictionary data?`, 'NOTE', {
                confirmButtonText: 'Confirm',
                cancelButtonText: 'Cancel',
                type: 'warning'
            }).then(() => {
